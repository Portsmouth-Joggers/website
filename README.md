...
1. Anyone can be involved.  The source is stored in a public repository on GitHub, so anyone join in, they just need a GitHub account.

2. Capture *everything* as [Issues](https://github.com/Portsmouth-Joggers/website/issues/):
...
4. Use Milestones for Major Updates:
...
6. Resolve Issues with this workflow:
    * When starting work on an issue, make a branch for it.
    * Resolve the issue in the branch.
    * When finished (or when you want someone else to take a look) push the branch to the public repo.
